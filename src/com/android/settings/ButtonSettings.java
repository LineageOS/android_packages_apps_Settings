...
public class ButtonSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        HashMap<String, String> prefsToRemove = (HashMap<String, String>) getPreferencesToRemove(this, getActivity());
    ...
    private static Map<String, String> getPreferencesToRemove(ButtonSettings settings, Context context) {
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<String> getNonIndexableKeys(Context context) {
                    ...
                    Intent intent = new Intent("com.cyanogenmod.action.LAUNCH_BLUETOOTH_INPUT_SETTINGS");
