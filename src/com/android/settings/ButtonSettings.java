...
public class ButtonSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCameraLaunchFromStandby =
                (SwitchPreference) findPreference(Settings.System.CAMERA_LAUNCH_FROM_STANDBY);
        ...
        if (mCameraWakeScreen != null) {
            ...
            if (mCameraLaunchFromStandby != null) {
                mCameraLaunchFromStandby.setDependency(Settings.System.CAMERA_WAKE_SCREEN);
            }
        }
