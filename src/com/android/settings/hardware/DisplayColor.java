...
public class DisplayColor extends DialogPreference {
    ...
    protected void onBindDialogView(View view) {
        ...
        for (int i = 0; i < SEEKBAR_ID.length; i++) {
            ...
            int min = mOriginalColors[CmHardwareManager.COLOR_CALIBRATION_MIN_INDEX];
            int max = mOriginalColors[CmHardwareManager.COLOR_CALIBRATION_MAX_INDEX];
            mSeekBars[i] = new ColorSeekBar(seekBar, value, i, min, max);
    ...
    protected void showDialog(Bundle state) {
        ...
        defaultsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int[] currentCalibration = mCmHardwareManager.getDisplayColorCalibration();
                int defaultValue = currentCalibration[CmHardwareManager.COLOR_CALIBRATION_DEFAULT_INDEX];
                for (int i = 0; i < mSeekBars.length; i++) {
                    mSeekBars[i].mSeekBar.setProgress(defaultValue);
                    mCurrentColors[i] = defaultValue;
                }
    ...
    public static void restore(Context context) {
        ...
        if (value != null) {
            ...
            rgb[CmHardwareManager.COLOR_CALIBRATION_RED_INDEX] = Integer.valueOf(values[0]);
            rgb[CmHardwareManager.COLOR_CALIBRATION_GREEN_INDEX] = Integer.valueOf(values[1]);
            rgb[CmHardwareManager.COLOR_CALIBRATION_BLUE_INDEX] = Integer.valueOf(values[2]);
