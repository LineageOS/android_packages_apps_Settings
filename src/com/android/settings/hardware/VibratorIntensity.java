...
public class VibratorIntensity extends DialogPreference implements
    ...
    protected void onBindDialogView(View view) {
        ...
        if (mWarningValue > 0) {
            String message = getContext().getResources().getString(
                    R.string.vibrator_warning, intensityToPercent(mMinValue, mMaxValue, mWarningValue));
    ...
    public static void restore(Context context) {
        ...
        int defaultValue = cmHardwareManager.getVibratorDefaultIntensity();
        defaultValue = intensityToPercent(min,
            max, defaultValue);
        int percent = prefs.getInt(PREF_NAME, defaultValue);

        cmHardwareManager.setVibratorIntensity(percentToIntensity(min,
            max, percent));
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        boolean shouldWarn =
                mWarningValue > 0 && progress >= intensityToPercent(mMinValue, mMaxValue, mWarningValue);
        ...
        mCmHardwareManager.setVibratorIntensity(percentToIntensity(mMinValue, mMaxValue, progress));
