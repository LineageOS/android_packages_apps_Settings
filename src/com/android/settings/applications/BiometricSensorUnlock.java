...
interface BiometricSensorUnlock {
     ...
     * {@link com.android.keyguard.BiometricSensorUnlock#start} is called, isRunning() returns false.  After a successful
     * call to {@link com.android.keyguard.BiometricSensorUnlock#start}, isRunning() returns true until the biometric
     * unlock completes, {@link com.android.keyguard.BiometricSensorUnlock#stop} has been called, or an error has
