...
/**
 * Created by Adnan on 2/3/15.
 */
public class ExpandedDesktopExtraPrefs extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener{
    ...
    public void createPreferences() {
        ...
        mExpandedDesktopStylePref.setDefaultValue(mExpandedDesktopStyle);
    ...
    private int getExpandedDesktopStyle() {
        int style = Settings.Global.getInt(getContentResolver(),
    ...
    public boolean onPreferenceChange(Preference preference, Object value) {
        ...
        Settings.Global.putInt(getContentResolver(),
                Settings.Global.POLICY_CONTROL_STYLE, val);
