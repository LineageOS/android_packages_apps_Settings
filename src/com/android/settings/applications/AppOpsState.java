...
public class AppOpsState {
    ...
    public List<AppOpEntry> buildState(OpsTemplate tpl, int uid, String packageName,
        ...
        final List<Integer> privacyGuardOps = new ArrayList<>();
            ...
            for (int i=0; i<pkgs.size(); i++) {
                ...
                for (int j=0; j<pkgOps.getOps().size(); j++) {
                    ...
                    if (privacyGuard && privacyGuardOps.contains(opEntry.getOp())) {
                        // Don't include Privacy Guard's OPs, the app may have never
                        // declared them. We will add them later if they were declared
                        // when we will query PackageManager.
                        continue;
                    }
