...
public class AppOpsDetails extends SettingsPreferenceFragment {
    ...
    private AppOpsState.OpsTemplate[] getTemplates() {
        ...
        // Loop all existing templates and store to op to find the missing ones later
        ...
        int missingIdx = 0;
        int[] missingOps = new int[AppOpsManager._NUM_OP - opIdx - 1];
        boolean[] showPerms = new boolean[AppOpsManager._NUM_OP - opIdx - 1];
