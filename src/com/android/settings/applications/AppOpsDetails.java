...
public class AppOpsDetails extends SettingsPreferenceFragment {
    ...
    private static HashMap<Integer, Integer> OP_ICONS = new HashMap<Integer, Integer>() {{
        put(AppOpsManager.OP_BOOT_COMPLETED, R.drawable.ic_perm_boot);
        put(AppOpsManager.OP_CHANGE_WIFI_STATE, R.drawable.ic_perm_wifi);
        put(AppOpsManager.OP_GPS, R.drawable.ic_perm_location);
        put(AppOpsManager.OP_MUTE_MICROPHONE, R.drawable.ic_perm_microphone);
        put(AppOpsManager.OP_NFC_CHANGE, R.drawable.ic_perm_nfc);
        put(AppOpsManager.OP_POST_NOTIFICATION, R.drawable.ic_perm_notifications);
        put(AppOpsManager.OP_READ_CLIPBOARD, R.drawable.ic_perm_clipboard);
        put(AppOpsManager.OP_RUN_IN_BACKGROUND, R.drawable.ic_perm_background);
        put(AppOpsManager.OP_SU, R.drawable.ic_perm_su);
        put(AppOpsManager.OP_SYSTEM_ALERT_WINDOW, R.drawable.ic_perm_drawontop);
        put(AppOpsManager.OP_TAKE_AUDIO_FOCUS, R.drawable.ic_perm_audio);
        put(AppOpsManager.OP_VIBRATE, R.drawable.ic_perm_vibrate);
        put(AppOpsManager.OP_WAKE_LOCK, R.drawable.ic_perm_nosleep);
        put(AppOpsManager.OP_WIFI_SCAN, R.drawable.ic_perm_wifi);
        put(AppOpsManager.OP_WRITE_CLIPBOARD, R.drawable.ic_perm_clipboard);
        put(AppOpsManager.OP_WRITE_SETTINGS, R.drawable.ic_perm_settings);
        put(AppOpsManager.OP_WRITE_SMS , R.drawable.ic_perm_sms);
    }};
