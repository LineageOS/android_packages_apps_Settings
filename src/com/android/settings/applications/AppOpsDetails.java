...
public class AppOpsDetails extends SettingsPreferenceFragment {
    ...
    private final int[] ICONS = {
            R.drawable.ic_perm_vibrate,
            R.drawable.ic_perm_settings,
            R.drawable.ic_perm_wifi
    };
    ...
    private void setAppLabelAndIcon(PackageInfo pkgInfo) {
        ...
        String pkgName = mPm.getApplicationLabel(appInfo).toString();
        ...
        try {
            ...
            Log.e(TAG, "Error loading application label for " + pkgName, t);
            label = pkgName;
        }

        AppHeader.createAppHeader(this, icon, label, pkgName, uid);
    }
        ...
        for (AppOpsState.OpsTemplate tpl : AppOpsState.ALL_TEMPLATES) {
            ...
            for (final AppOpsState.AppOpEntry entry : entries) {
                ...
                for (int i = 0; i < entry.getNumOpEntry() && perm == null; i++) {
                    perm = AppOpsManager.opToPermission(entry.getOpEntry(i).getOp());
                }
                if (perm != null) {
                    try {
                        ...
                        if (pi.group != null) {
                            ...
                            if (pgi.icon != 0) {
                                ...
                                icon = getDrawableForPermission(pi.group);
                            }
                        } else {
                            icon = getDrawableForPermission(perm);
                        }
                    } catch (NameNotFoundException e) {
                    }
                }
                ...
                int mode = mAppOps.checkOpNoThrow(switchOp, pkgOps.getUid(),
                ...
                if (AppOpsManager.isStrictOp(switchOp)) {
                    ...
                    listPref.setKey(opName.toString());
                    ...
                    listPref.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
                        ...
                        public boolean onPreferenceChange(Preference preference, Object newValue) {
                            ...
                            mAppOps.setMode(switchOp, pkgOps.getUid(), pkgOps.getPackageName(),
    ...
    private Drawable getDrawableForPermission(String permission)
    {
        Log.d(TAG, "getDrawableForPermission " + permission);
        int id = -1;
        ...
        if (id != -1) {
            return getActivity().getResources().getDrawable(id, getActivity().getTheme());
        }
