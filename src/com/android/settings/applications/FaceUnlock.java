...
public class FaceUnlock implements BiometricSensorUnlock, Handler.Callback {
    ...
    ProtectedAppSecurityCallback mProtectedAppSecurityCallback;
    ...
    public void setSecurityCallback(ProtectedAppSecurityCallback protectedAppSecurityCallback) {
        mProtectedAppSecurityCallback = protectedAppSecurityCallback;
    }
    ...
    void handleServiceConnected() {
        ...
        if (mFaceUnlockView != null) {
            ...
            if (windowToken != null) {
                ...
                // is restarted.
                mProtectedAppSecurityCallback.userActivity(0);
    ...
    void handleUnlock(int authenticatedUserId) {
        ...
        if (authenticatedUserId == currentUserId) {
            ...
            mProtectedAppSecurityCallback.reportSuccessfulUnlockAttempt();
            mProtectedAppSecurityCallback.dismiss(true);
        } else {
    ...
    void handleCancel() {
        ...
        mProtectedAppSecurityCallback.showBackupSecurity();
        stop();
        mProtectedAppSecurityCallback.userActivity(BACKUP_LOCK_TIMEOUT);
    }
...
//
        mProtectedAppSecurityCallback.reportFailedUnlockAttempt();
    }
    ...
    void handlePokeWakelock(int millis) {
      ...
      if (powerManager.isScreenOn()) {
            mProtectedAppSecurityCallback.userActivity(millis);
      }
    }
