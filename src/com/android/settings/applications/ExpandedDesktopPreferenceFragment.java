...
public class ExpandedDesktopPreferenceFragment extends SettingsPreferenceFragment
        implements AdapterView.OnItemClickListener, ApplicationsState.Callbacks, AbsListView.MultiChoiceModeListener {
    ...
    private static final int STATE_DISABLE_FOR_ALL = 2;
    ...
    private View.OnClickListener mAddAllButtonClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            ...
            for (int i = 0; i < count; i++) {
                if (positions.valueAt(i)) {
                    mUserPackagesAdapter.add(
                            mAllPackagesAdapter.entries.get(positions.keyAt(i)).info.packageName);
                }
            }
    ...
    private AdapterView.OnItemClickListener mAllAppsClickListener
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            if (mAllListView.getCheckedItemCount() == 1
                ...
                mNeedCallRebuild = true;
                hideAllApps();
            } else if (mAllListView.getCheckedItemCount() == 0) {
                hideAddAll();
            }
        }
    };
    ...
    private void showAddAll() {
        Animator a = ObjectAnimator.ofFloat(mAddAll, View.TRANSLATION_X, -144).setDuration(200);
    ...
    private void hideAddAll() {
        Animator a = ObjectAnimator.ofFloat(mAddAll, View.TRANSLATION_X, 0).setDuration(200);
        a.setInterpolator(mInterpolator);
        a.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                mAddAll.setVisibility(View.INVISIBLE);
            }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdd = (Button) view.findViewById(R.id.btn_add_close);
        mAdd.setBackground(new RippleDrawable(ColorStateList.valueOf(Color.WHITE), mAddCloseDrawable, null));
        mAdd.setOnClickListener(mAddCloseButtonClickListener);

        mAddAll = (Button) view.findViewById(R.id.btn_add_all);
        mAddAll.setBackground(new RippleDrawable(ColorStateList.valueOf(Color.WHITE), mAddAllDrawable, null));
        mAddAll.setOnClickListener(mAddAllButtonClickListener);
