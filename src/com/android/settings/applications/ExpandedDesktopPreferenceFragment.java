...
public class ExpandedDesktopPreferenceFragment extends SettingsPreferenceFragment
    ...
    private class AllPackagesAdapter extends BaseAdapter implements AdapterView.OnItemSelectedListener {
            ...
            for (int i = 0; i < newEntries.size(); i++) {
                ...
                if (entry == null) {
                    ...
                    if (this.entries.contains(entry)) {
                        System.out.println("This contains " + entry.getNormalizedLabel());
                        // update
