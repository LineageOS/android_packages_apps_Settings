...
public class InputMethodAndLanguageSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (pointerSettingsCategory != null) {
            ...
            if (!mCmHardwareManager.isSupported(CmHardwareManager.FEATURE_TOUCH_HOVERING)) {
                ...
                mTouchscreenHovering.setChecked(mCmHardwareManager.get(CmHardwareManager.FEATURE_TOUCH_HOVERING));
            }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mStylusIconEnabled) {
            ...
            return mCmHardwareManager.set(CmHardwareManager.FEATURE_TOUCH_HOVERING, mTouchscreenHovering.isChecked());
        }
