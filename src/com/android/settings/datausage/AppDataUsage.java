...
import static android.net.NetworkPolicyManager.POLICY_REJECT_ALL_ISOLATED;
...
public class AppDataUsage extends DataUsageBaseFragment implements OnPreferenceChangeListener,
    ...
    private static final String KEY_RESTRICT_ALL = "restrict_all_isolated";
    ...
    private boolean getAppRestrictAll() {
        return getAppRestriction(POLICY_REJECT_ALL_ISOLATED);
    }
    ...
    private void setAppRestrictAll(boolean restrict) {
        setAppRestriction(POLICY_REJECT_ALL_ISOLATED, restrict);
    }
