...
public class AppDataUsage extends DataUsageBaseFragment implements OnPreferenceChangeListener,
    ...
    private void updatePrefs(boolean restrictBackground, boolean unrestrictData,
        ...
        if (mRestrictBackground != null) {
            ...
            mRestrictBackground.setEnabled(!restrictAll && !restrictCellular &&
                    !mRestrictBackground.isDisabledByAdmin());
        ...
        if (mUnrestrictedData != null) {
            ...
            mUnrestrictedData.setEnabled(!restrictBackground && !restrictAll && !restrictCellular &&
                    !mRestrictBackground.isDisabledByAdmin());
