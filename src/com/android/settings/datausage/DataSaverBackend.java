...
public class DataSaverBackend {
    ...
    private int[] mRestrictAllDenyList;
    ...
    private void loadDenylist() {
        ...
        final int[] allDenyList
                = mPolicyManager.getUidsWithPolicy(POLICY_REJECT_ALL);
        if (mRestrictAllDenyList == null ||
                !Arrays.equals(mRestrictAllDenyList, allDenyList)) {
            mRestrictAllDenyList = allDenyList;
            for (int uid : allDenyList) {
        ...
        if (mRestrictBackgroundDenyList == null ||
                ...
                !Arrays.equals(backgroundDenyList, allDenyList)) {
