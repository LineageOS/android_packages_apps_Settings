...
public class StatusBarSettings extends SettingsPreferenceFragment
    ...
    private void initUI() {
        mShowBatteryPercentage =
            (CheckBoxPreference) findPreference(Settings.System.STATUS_BAR_SHOW_BATTERY_PERECENT);
        boolean showPercentage = Settings.System.getInt(
            getContentResolver(),
            Settings.System.STATUS_BAR_SHOW_BATTERY_PERECENT, 0) > 0;
    ...
    public void onSharedPreferenceChanged(SharedPreferences preferences, String key) {
        if (key.equals(Settings.System.STATUS_BAR_SHOW_BATTERY_PERECENT)) {
            boolean showPercentage = preferences.getBoolean(key, true);
            Settings.System.putInt(getContentResolver(),
                                   Settings.System.STATUS_BAR_SHOW_BATTERY_PERECENT,
                                   showPercentage ? 1 : 0);
        }
    }
}
