...
public class GestureNavigationBackSensitivityDialog extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        // Remove "\n" here so we don't have to remove it in @string for every translation.
        final TextView sensitivityMsg = view.findViewById(R.id.back_sensitivity_dialog_message);
        sensitivityMsg.setText(sensitivityMsg.getText().toString().replace("\n", ""));
        ...
        return new AlertDialog.Builder(getContext())
                ...
                .setPositiveButton(R.string.okay, (dialog, which) -> {
                    ...
                    int hideHintEnabled = hideHintSwitch.isChecked() ? 1 : 0;
