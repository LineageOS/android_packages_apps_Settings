...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        PreferenceCategory interfacePrefs = (PreferenceCategory) findPreference(KEY_CATEGORY_INTERFACE);
        PreferenceCategory calibrationPrefs = (PreferenceCategory) findPreference(KEY_CATEGORY_CALIBRATION);
        ...
        if (calibrationPrefs != null && mColorEnhancement != null && !isColorEnhancementSupported()) {
        ...
        if (mDozePreference != null && isDozeAvailable(activity)) {
            ...
            if (calibrationPrefs != null && mDozePreference != null) {
                calibrationPrefs.removePreference(mDozePreference);
            }
        }

        mTapToWake = (SwitchPreference) findPreference(KEY_TAP_TO_WAKE);
        if (calibrationPrefs != null && !isTapToWakeSupported()) {
            calibrationPrefs.removePreference(mTapToWake);
            mTapToWake = null;
        }

        boolean proximityCheckOnWke = getResources().getBoolean(
                com.android.internal.R.bool.config_proximityCheckOnWake);
        if (calibrationPrefs != null && !proximityCheckOnWke) {
        ...
        if (displayPrefs != null && !isPostProcessingSupported(getActivity())
