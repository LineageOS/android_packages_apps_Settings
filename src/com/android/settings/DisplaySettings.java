...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (displayPrefs != null && !isAdaptiveBacklightSupported()) {
        ...
        if (displayPrefs != null && mSunlightEnhancement != null
        ...
        if (displayPrefs != null && mColorEnhancement != null && !isColorEnhancementSupported()) {
            displayPrefs.removePreference(mColorEnhancement);
            mColorEnhancement = null;
        }

        if (displayPrefs != null && !DisplayColor.isSupported()) {
            Preference colorPref = findPreference(KEY_DISPLAY_COLOR);
            if (colorPref != null) {
                displayPrefs.removePreference(colorPref);
            }
        }
        if (displayPrefs != null && !DisplayGamma.isSupported()) {
            Preference gammaPref = findPreference(KEY_DISPLAY_GAMMA);
            if (gammaPref != null) {
                displayPrefs.removePreference(gammaPref);
            }
        }
        ...
        if (displayPrefs != null && !proximityCheckOnWke) {
