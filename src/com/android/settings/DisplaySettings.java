...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNetworkNameDisplayedPreference =
                (SwitchPreference) findPreference(KEY_NETWORK_NAME_DISPLAYED);
        if (mNetworkNameDisplayedPreference != null && enableOperatorName) {
            mNetworkNameDisplayedPreference.setOnPreferenceChangeListener(this);
        } else {
            if (displayPrefs != null && mNetworkNameDisplayedPreference != null) {
        ...
        if (RotationPolicy.isRotationLockToggleVisible(activity)) {
            ...
            if (displayPrefs != null && rotatePreference != null) {
        ...
        if (isVrDisplayModeAvailable(activity)) {
            ...
            if (displayPrefs != null && vrDisplayPref != null) {
