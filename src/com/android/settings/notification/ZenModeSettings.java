...
public class ZenModeSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    private static final SettingPrefWithCallback PREF_ZEN_MUSIC_NOTIFICATIONS = new SettingPrefWithCallback(
            SettingPref.TYPE_GLOBAL, KEY_MUSIC_INTERRUPTIONS, Global.ZEN_DISABLE_DUCKING_WHILE_ACTIVE_MEDIA,
            0, 1) {
        protected String getCaption(Resources res, int value) {
            switch (value) {
                case Global.ZEN_MODE_NO_INTERRUPTIONS:
