...
public class SoundTimeoutPreferenceController extends NotificationPreferenceController
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        final long soundTimeout = Long.valueOf((String) newValue);
        if (mAppRow != null) {
            mAppRow.soundTimeout = soundTimeout;
            mBackend.setNotificationSoundTimeout(mAppRow.pkg, mAppRow.uid, soundTimeout);
        }
        return true;
    }
