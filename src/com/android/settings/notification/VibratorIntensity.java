...
public class VibratorIntensity extends CustomDialogPreference
    ...
    protected void onBindDialogView(final View view) {
        ...
        try {
            mServer = IVibrator.getService("default");

            // Read the current value in case user wants to dismiss his changes
            mOriginalValue = mServer.getIntensity();
            mWarningValue = mServer.getDefaultIntensity();
        ...
        final String message = getContext().getResources().getString(
                ...
                intensityToPercent(0, 255, mWarningValue));
    ...
    protected void onDialogClosed(final boolean positiveResult) {
        ...
        if (positiveResult) {
            ...
            final int percent = intensityToPercent(0, 255, intensity);
            prefs.edit().putInt(LineageSettings.Secure.VIBRATOR_INTENSITY, percent).commit();
            ...
            LineageSettings.Secure.putInt(getContext().getContentResolver(),
                    LineageSettings.Secure.VIBRATOR_INTENSITY, mOriginalValue);
        }
    }
    ...
    public void onProgressChanged(
        ...
        mValueText.setText(
                String.format("%d%%", intensityToPercent(0, 255, intensity)));
    }
    ...
    public void onStopTrackingTouch(final SeekBar seekBar) {
        setVibratorIntensity(seekBar.getProgress());
        testVibration();
    }
