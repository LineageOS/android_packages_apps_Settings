...
public class EnrollFingerprint extends SettingsActivity
    ...
    SetupWizardNavBar.NavigationBarListener mFragmentListener;
    ...
    public static class EnrollFingerprintFragment extends Fragment
         ...
         */
        private static final long TIME_TO_COMPLETE_ENROLLMENT = 1 * DateUtils.MINUTE_IN_MILLIS;
        ...
        // TODO: remove vibrator once implemented service side
        ...
        private void showWrongSensorDialog() {
            ...
            dialogFragment.show(getChildFragmentManager(), "Wrong sensor");
        }

        private void showFailedEnrollmentDialog() {
            DialogFragment dialogFragment = FailedEnrollmentDialogFragment.newInstance(this);
            dialogFragment.show(getChildFragmentManager(), "Failed enrollment");
        }
        ...
        private FingerprintManagerReceiver mFingerprintReceiver = new FingerprintManagerReceiver() {
            ...
            public void onError(int error) {
                super.onError(error);
                // TODO: remove log statement when no longer needed
                Log.d("EnrollmentError", "error=" + error);
