...
public class RingerVolumePreference extends VolumePreference {
    ...
    protected void onBindDialogView(View view) {
        ...
        final CheckBox safeHeadsetVolumeRestore = (CheckBox) view.findViewById(R.id.safe_headset_volume_restore);
        ...
        safeHeadsetVolumeRestore.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
