...
public class FingerprintUnlockPreferenceController extends AbstractPreferenceController
    ...
    public boolean isAvailable() {
        ...
        final boolean isSideFps = mContext.getResources().getBoolean(
                com.android.internal.R.bool.config_is_powerbutton_fps);
        // Also disable for device which sets overlay false by default
        final boolean isDisabled = LineageSettings.System.getIntForUser(
                mContext.getContentResolver(),
                LineageSettings.System.FINGERPRINT_WAKE_UNLOCK, 1,
                UserHandle.USER_CURRENT) == 2;
        return !isDisabled && isSideFps;
    }
