...
public class SimSettings extends RestrictedSettingsFragment implements Indexable,
    ...
    public void onDestroy() {
        TelephonyExtUtils.removeListener(this);
        super.onDestroy();
    }
    ...
    private class SimEnablerPreference extends SimPreference implements OnCheckedChangeListener {
        ...
        public void onBindViewHolder(PreferenceViewHolder holder) {
            ...
            if (!TelephonyExtUtils.hasService() ||
        ...
        public void update() {
            ...
            mUiccProvisionStatus[mSlotId] = TelephonyExtUtils.hasService() ?
                    TelephonyExtUtils.getCurrentUiccCardProvisioningStatus(mSlotId) :
                    PROVISIONED;
        ...
        private class SimEnablerDisabler extends AsyncTask<Void, Void, Integer> {
            ...
            protected Integer doInBackground(Void... params) {
                int result = mIsChecked ?
                        TelephonyExtUtils.activateUiccCard(mSlotId) :
                        TelephonyExtUtils.deactivateUiccCard(mSlotId);
                newProvisionedState =
                        TelephonyExtUtils.getCurrentUiccCardProvisioningStatus(mSlotId);
                return result;
            }
