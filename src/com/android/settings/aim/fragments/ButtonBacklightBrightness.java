...
import com.android.settings.aim.Preferences.CustomDialogPreference;
...
public class ButtonBacklightBrightness extends CustomDialogPreference<AlertDialog> implements
    ...
    public boolean isButtonSupported() {
        ...
        boolean hasBacklightKey = (deviceKeys & HardwareKeys.KEY_MASK_HOME) != 0
                || (deviceKeys & HardwareKeys.KEY_MASK_BACK) != 0
                || (deviceKeys & HardwareKeys.KEY_MASK_MENU) != 0
                || (deviceKeys & HardwareKeys.KEY_MASK_ASSIST) != 0
                || (deviceKeys & HardwareKeys.KEY_MASK_APP_SWITCH) != 0;
