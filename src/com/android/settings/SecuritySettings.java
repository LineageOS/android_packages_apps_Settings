    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        if (resid == R.xml.security_settings_biometric_weak &&
            ...
            if (securityCategory != null) {
                if (mVisiblePattern != null) securityCategory.removePreference(mVisiblePattern);
                if (mVisibleErrorPattern != null) securityCategory.removePreference(mVisibleErrorPattern);
                if (mVisibleDots != null) securityCategory.removePreference(mVisibleDots);
            }
        }
