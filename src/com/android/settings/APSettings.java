...
public class APSettings extends SettingsPreferenceFragment
    ...
    private void scan() {
        ...
        for (ClientScanResult clientScanResult : clients) {
            ...
            /*Log.i("AP", "IpAddr: " + clientScanResult.getIpAddr() + "\n");
            Log.i("AP", "Device: " + clientScanResult.getDevice() + "\n");
            Log.i("AP", "HWAddr: " + clientScanResult.getHWAddr() + "\n");
            Log.i("AP", "isReachable: " + clientScanResult.isReachable() + "\n");*/
