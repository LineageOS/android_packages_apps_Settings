...
public class ColorModePreferenceFragment extends RadioButtonPickerFragment {
    ...
    protected List<? extends CandidateInfo> getCandidates() {
        ...
        if (availableVendorColorModes != null) {
            ...
            new BaseSearchIndexProvider(R.xml.color_mode_settings) {
                ...
                protected boolean isPageSearchEnabled(Context context) {
                    final int[] availableColorModes = context.getResources().getIntArray(
                            com.android.internal.R.array.config_availableColorModes);
                    final int[] availableVendorColorModes = context.getResources().getIntArray(
                            R.array.available_vendor_color_modes);
                    final boolean hasColorModes =
                            availableColorModes != null && availableColorModes.length > 0;
                    final boolean hasVendorColorModes = hasColorModes &&
                            availableVendorColorModes != null &&
                            availableVendorColorModes.length > 0;
                    return (hasColorModes || hasVendorColorModes)
