...
public class LidBehaviorPreferenceController extends BasePreferenceController
    ...
    public int getAvailabilityStatus() {
        ...
        if (resources.getBoolean(com.android.internal.R.bool.config_lidControlsSleep)) {
            return AVAILABLE;
        }
        if (resources.getBoolean(com.android.internal.R.bool.config_lidControlsScreenLock)) {
            return AVAILABLE;
        }
