...
public class MasterClear extends Fragment {
    ...
    private void showFinalConfirmation() {
        ...
        preference.getExtras().putBoolean(EXTRA_WIPE_MEDIA, mInternalStorage.isChecked());
        preference.getExtras().putBoolean(EXTRA_WIPE_SDCARD, mExternalStorage.isChecked());
    ...
    private void establishInitialState() {
        ...
        if (Environment.isExternalStorageEmulated()) {
            ...
            final boolean storageEncrypted = !Environment.isExternalStorageRemovable() && isExtStorageEncrypted();
            mInternalStorageContainer.setEnabled(!storageEncrypted);
            if (mInternalStorageContainer.isEnabled()) {
                ...
                TextView internalSummaryText = (TextView) mContentView.findViewById(R.id.erase_storage_checkbox_description);
                internalSummaryText.setText(R.string.factory_reset_erase_stored_content_summary_forced);
            }
