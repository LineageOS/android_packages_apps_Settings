    ...
    static class SummaryProvider implements SummaryLoader.SummaryProvider {
        ...
        public void setListening(boolean listening) {
            if (listening) {
                ...
                final String btString = mContext.getString(R.string.bluetooth);
                final String castString = mContext.getString(R.string.wifi_display_settings_title);
                final String nfcString = mContext.getString(R.string.nfc_quick_toggle_title);
                String summary = (isBluetoothAvailable ? btString + ", " : "") + castString +
                        (isNfcAvailable ?  ", " + nfcString : "");
