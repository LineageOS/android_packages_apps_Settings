    ...
    static class SummaryProvider implements SummaryLoader.SummaryProvider {
        ...
        public void setListening(boolean listening) {
            if (listening) {
                ...
                if (isBluetoothAvailable && isNfcAvailable) {
                    mSummaryLoader.setSummary(this,
                        mContext.getString(R.string.connected_devices_dashboard_summary));
                } else if (isBluetoothAvailable && !isNfcAvailable) {
                    mSummaryLoader.setSummary(this, mContext.getString(
                        R.string.connected_devices_dashboard_summary_no_nfc));
                } else if (!isBluetoothAvailable && isNfcAvailable) {
                    mSummaryLoader.setSummary(this,
                        mContext.getString(R.string.connected_devices_dashboard_summary_no_bluetooth));
                } else if (!isBluetoothAvailable && !isNfcAvailable) {
                   mSummaryLoader.setSummary(this, mContext.getString(
                        R.string.connected_devices_dashboard_summary_no_bluetooth_no_nfc));
                }
            }
        }
    }
