...
public class WifiApSettings extends SettingsPreferenceFragment
    ...
    private ArrayList<WifiApSettings.ClientScanResult> clients_old;
    ...
    private void scan() {
        final Activity activity = getActivity();
        ArrayList<WifiApSettings.ClientScanResult> clients = mWifiApManager.getClientList(false);
        if (!clients.equals(clients_old)) {
            clients_old = clients;
            clientsCategory.removeAll();
...
(probably disconnected) clients, {@code true} otherwise
         ...
         */
        public ArrayList<WifiApSettings.ClientScanResult> getClientList(boolean onlyReachables) {
        ...
        class getClientList extends AsyncTask<String, Integer, ArrayList<ClientScanResult>> {
            ...
            ArrayList<WifiApSettings.ClientScanResult> result = null;
            ...
            protected ArrayList<WifiApSettings.ClientScanResult> doInBackground(String... sUrl) {
                try {
                    result = new ArrayList<WifiApSettings.ClientScanResult>();
                        ...
                        if (splitted.length >= 4) {
                            ...
                            if (mac.matches("..:..:..:..:..:..")) {
                                ...
                                if (!onlyReachables || isReachable) {
                                    result.add(new WifiApSettings.ClientScanResult(splitted[0],
