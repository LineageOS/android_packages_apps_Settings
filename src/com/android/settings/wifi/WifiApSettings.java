...
public class WifiApSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (wifiAvailable && !Utils.isMonkeyRunning()) {
            ...
            mWifiApEnabler = new WifiApEnabler(activity, actionBarSwitch, this);
        ...
        if (mApEnabled) {
            ...
            if (mLastClientList != null) {
                for (ClientsList.ClientScanResult client : mLastClientList) {
                    ...
                    preference.setSummary(client.hwAddr);
    ...
    private final class ClientUpdateHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            final Activity activity = getActivity();
            ArrayList<ClientsList.ClientScanResult> clients = (ArrayList<ClientsList.ClientScanResult>) msg.obj;
    ...
    private final class ClientScanHandler extends Handler {
        ...
        @Override
        public void handleMessage(Message msg) {
            ArrayList<ClientsList.ClientScanResult> clients = ClientsList.getInstance().getClientList(true);
