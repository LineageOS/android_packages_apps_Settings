...
public class AdvancedWifiSettings extends SettingsPreferenceFragment
    ...
    private void initPreferences() {
        ...
        if (mWifiManager.isDualBandSupported()) {
            ...
            try {
                int value = Settings.Global.getInt(getContentResolver(), Global.WIFI_FREQUENCY_BAND);
                if (value != -1) {
        ...
        if (ccodePref != null) {
            ...
            String value = Settings.Global.getString(getContentResolver(), Settings.Global.WIFI_COUNTRY_CODE);
            if (value != null) {
                ccodePref.setValue(value);

                // make sure this country code is in use
                if (!mWifiManager.getCountryCode().equals(value))
