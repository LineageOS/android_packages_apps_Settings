...
public class StorageSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    static final int COLOR_PUBLIC = Color.(res.getColor(R.color.storage_summary_color_grey));
    static final int COLOR_WARNING = Color.(res.getColor(R.color.storage_summary_color_red));

    static final int[] COLOR_PRIVATE = new int[] {
            Color.(res.getColor(R.color.storage_summary_color_teal)),
            Color.(res.getColor(R.color.storage_summary_color_purple)),
            Color.(res.getColor(R.color.storage_summary_color_orange)),
            Color.(res.getColor(R.color.storage_summary_color_pink)),
            Color.(res.getColor(R.color.storage_summary_color_green)),
    };
