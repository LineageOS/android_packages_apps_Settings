...
public class StorageVolumePreferenceCategory extends PreferenceCategory
    ...
    private StorageVolumePreferenceCategory(Context context, StorageVolume volume) {
        ...
        mIsRemovable = mVolume != null && mVolume.isRemovable() ? true : false;
        mIsUsbStorage = mVolume != null && mVolume.getDescription(context).equals(
                Resources.getSystem().getString(Resources.getSystem().getIdentifier(
                "storage_usb", "string", "android"))) ? true : false;
    ...
    public void init() {
        ...
        if (mIsRemovable && (mIsUsbStorage || isAccessible)) {
            mMountTogglePreference.setTitle(mIsUsbStorage ? R.string.usb_eject : R.string.sd_eject);
            mMountTogglePreference.setSummary(mIsUsbStorage ? R.string.usb_eject_summary : R.string.sd_eject_summary);
        ...
        if (allowFormat) {
            ...
            mFormatPreference.setTitle(mIsUsbStorage ? R.string.usb_format : R.string.sd_format);
            mFormatPreference.setSummary(mIsUsbStorage ? R.string.usb_format_summary : R.string.sd_format_summary);
    ...
    private void updatePreferencesFromState() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(state)
            ...
            mMountTogglePreference.setEnabled(true);
            mMountTogglePreference.setTitle(mResources.getString(mIsUsbStorage ? R.string.usb_eject : R.string.sd_eject));
            mMountTogglePreference.setSummary(mResources.getString(mIsUsbStorage ? R.string.usb_eject_summary : R.string.sd_eject_summary));
            addPreference(mUsageBarPreference);
            addPreference(mItemTotal);
            addPreference(mItemAvailable);
        } else {
            if (Environment.MEDIA_UNMOUNTED.equals(state) || Environment.MEDIA_NOFS.equals(state)
                ...
                mMountTogglePreference.setEnabled(true);
                mMountTogglePreference.setTitle(mResources.getString(mIsUsbStorage ? R.string.usb_mount : R.string.sd_mount));
                mMountTogglePreference.setSummary(mResources.getString(mIsUsbStorage ? R.string.usb_mount_summary : R.string.sd_mount_summary));
            } else {
                mMountTogglePreference.setEnabled(false);
                mMountTogglePreference.setTitle(mResources.getString(mIsUsbStorage ? R.string.usb_mount : R.string.sd_mount));
                mMountTogglePreference.setSummary(mResources.getString(mIsUsbStorage ? R.string.usb_insert_summary : R.string.sd_insert_summary));
            }
        ...
        if (mUsbConnected && (UsbManager.USB_FUNCTION_MTP.equals(mUsbFunction) ||
            ...
            mFormatPreference.setSummary(mResources.getString(mIsUsbStorage ? R.string.usb_format_summary : R.string.sd_format_summary));
        }
    }
