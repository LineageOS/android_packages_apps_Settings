...
public class SpamList extends ListFragment {
    ...
    private static final Uri mPackagesUri;
    private static final Uri mNotificationForPackageUri;
    static {
        Uri.Builder builder = new Uri.Builder();
        builder.scheme(ContentResolver.SCHEME_CONTENT);
        builder.authority(SpamFilter.AUTHORITY);
        builder.encodedPath("packages");
        mPackagesUri = builder.build();

        builder.encodedPath("message").build();
        mNotificationForPackageUri = builder.build();
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        getActivity().getContentResolver().registerContentObserver(
                SpamFilter.sNotificationUri, true, mObserver);
    }
    ...
    private class FetchFilters extends AsyncTask<Void, Void, List<ItemInfo>> {
        ...
        private void addNotificationsForPackage(PackageInfo pInfo, List<ItemInfo> items) {
            Uri notificationUri = Uri.withAppendedPath(mNotificationForPackageUri, String.valueOf(pInfo.id));
        ...
        protected List<ItemInfo> doInBackground(Void... params) {
            ...
            Cursor c = getActivity().getContentResolver().query(
                    mPackagesUri, null, null, null, null);
            if (c != null) {
    ...
    private class SpamAdapter extends BaseAdapter {
        ...
        public void removeItem(int position) {
            ...
            Uri uri = Uri.withAppendedPath(mNotificationForPackageUri,
