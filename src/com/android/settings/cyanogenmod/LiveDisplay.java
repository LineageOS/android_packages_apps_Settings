...
public class LiveDisplay extends SettingsPreferenceFragment implements
    ...
    private static final String KEY_LIVE_DISPLAY_DAY_TEMPERATURE = "live_display_day_temperature";
    private static final String KEY_LIVE_DISPLAY_NIGHT_TEMPERATURE = "live_display_night_temperature";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLiveDisplay.setSummary(getResources().getStringArray(R.array.live_display_summaries)[displayMode]);
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if (preference == mLiveDisplay) {
            ...
            Settings.System.putInt(getContentResolver(), Settings.System.DISPLAY_TEMPERATURE_MODE, value);
            mLiveDisplay.setSummary(getResources().getStringArray(R.array.live_display_summaries)[value]);
        }
        return true;
    }
