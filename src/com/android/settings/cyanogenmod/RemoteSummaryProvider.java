...
public class RemoteSummaryProvider extends BroadcastReceiver
    ...
    public void onReceive(Context context, Intent intent) {
        if (ACTION_REFRESH_SUMMARY.equals(intent.getAction()) &&
                isOrderedBroadcast() && getResultCode() == Activity.RESULT_OK) {
    ...
    public void setListening(boolean listening) {
        if (listening) {
            ...
            mActivity.sendOrderedBroadcastAsUser(i, UserHandle.CURRENT,
                    Manifest.permission.WRITE_SETTINGS, this, null,
