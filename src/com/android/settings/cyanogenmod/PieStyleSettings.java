...
public class PieStyleSettings extends SettingsPreferenceFragment implements
    ...
    private static final int PIE_CONTROL_SIZE_DEFAULT = 37;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mPieBackgroundAlpha) {
            int val = Integer.valueOf((int)newValue);
            Log.e("R", "value: " + val);
            Settings.System.putInt(getActivity().getContentResolver(),
    ...
    private void updateStyleValues() {
        ...
        int defaultAlpha;
        try{
            defaultAlpha = Settings.System.getInt(getActivity()
        ...
        mPieBackgroundAlpha.setProgress(defaultAlpha);

        int controlSize;
        try{
            controlSize = Settings.System.getInt(getActivity()
                    .getContentResolver(), Settings.System.PIE_SIZE);
        } catch (Exception e) {
            Log.e("R", "Error while reading size value! Restore to default.");
            controlSize = PIE_CONTROL_SIZE_DEFAULT;
            Settings.System.putInt(getActivity().getContentResolver(),
                Settings.System.PIE_SIZE, controlSize);
        }

        mPieControlSize.setProgress(controlSize);
