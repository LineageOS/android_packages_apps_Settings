...
public class PieButtonStyleSettings extends SettingsPreferenceFragment implements
    ...
    private void resetToDefault() {
        ...
        Settings.System.putInt(getActivity().getContentResolver(),
                Settings.System.PIE_BUTTON_ALPHA, 30);
        Settings.System.putInt(getActivity().getContentResolver(),
                Settings.System.PIE_BUTTON_PRESSED_ALPHA, 0);
        Settings.System.putInt(getActivity().getContentResolver(),
    ...
    private void updateStyleValues() {
        ...
        mPieButtonAlpha.setProgress(defaultAlpha);
        ...
        mPieButtonPressedAlpha.setProgress(defaultAlpha);
