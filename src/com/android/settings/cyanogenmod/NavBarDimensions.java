...
public class NavBarDimensions extends SettingsPreferenceFragment implements
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        menu.add(0, MENU_RESET, 0, R.string.navbar_dimensions_reset)
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            switch (id) {
                case DLG_RESET:
                    ...
                    .setTitle(R.string.navbar_dimensions_reset)
                    .setMessage(R.string.navbar_dimensions_reset_message)
                    .setNegativeButton(R.string.navbar_dimensions_cancel, null)
                    .setPositiveButton(R.string.navbar_dimensions_ok,
