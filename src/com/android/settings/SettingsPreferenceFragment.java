...
public class SettingsPreferenceFragment extends PreferenceFragment implements
                ...
                public void run() {
                    getListView().setOnScrollListener(new OnScrollListener() {
                        ...
                        public void onScrollStateChanged(AbsListView view,
                            ...
                            if (this.currentVisibleItemCount > 0 && scrollState == OnScrollListener.SCROLL_STATE_IDLE) {
                                // we stopped
                                // if we found our preference, we're done
                                if (highlightPreference(highlightedPosition)) {
                                    getListView().setOnScrollListener(null);
                                }
                            }
                        }
                    });
                    // smoothly scroll to preference
                    getListView().smoothScrollToPosition(highlightedPosition);
                }
            }, 300);
        }
        // remove listener
    ...
    private boolean highlightPreference(int position) {
