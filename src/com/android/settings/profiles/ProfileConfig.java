...
import com.android.settings.profiles.ProfilesUtils;
...
public class ProfileConfig extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (ProfilesUtils.deviceSupportsBluetooth()) {
        ...
        if (ProfilesUtils.deviceSupportsMobileData(getActivity())) {
