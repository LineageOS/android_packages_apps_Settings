...
public class TriggerPagerAdapter extends FragmentPagerAdapter {
    ...
    public void add(final Class<? extends Fragment> className, final Bundle params, final int titleResId) {
    ...
    public CharSequence getPageTitle(final int position) {
        return mFragmentActivity.getResources().getString(mHolderList.get(position).mTitleResId);
    }
