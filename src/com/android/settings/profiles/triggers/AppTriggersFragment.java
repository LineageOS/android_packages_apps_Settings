...
//        view.addView(mEmptyView);
    ...
    public class AppTrigger extends AbstractTriggerItem {
        ...
        public String getTitle() {
            return mTriggerInfo.getTriggerDisplayName();
        }

        @Override
        public String getSummary() {
            String state = mTriggerInfo.getCurrentState();
            if (state == null) {
                state = mProfile.getStringTrigger(mTriggerInfo.getPackage(), mTriggerInfo.getTriggerId());
            }
            return state;
        }
