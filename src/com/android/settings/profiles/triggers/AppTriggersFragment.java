...
public class AppTriggersFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mProfilePluginManager = new ProfilePluginManager();
    }
...
//        view.addView(mEmptyView);
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        triggerType = Profile.TriggerType.STRING;
        ...
        new AlertDialog.Builder(getActivity())
                ...
                .setSingleChoiceItems(values, currentItemIdx, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        mProfile.setTrigger(triggerType, triggerPackage, triggerId, values[which]);
    ...
    private void reloadTriggerListItems() {
        ...
        List<CustomTriggerInfo> registeredTriggers = mProfilePluginManager.getRegisteredTriggers();
        for (CustomTriggerInfo trigger : registeredTriggers) {
    ...
    public static class AppTrigger extends AbstractTriggerItem {
        CustomTriggerInfo mTriggerInfo;

        public AppTrigger(CustomTriggerInfo triggerInfo) {
            this.mTriggerInfo = triggerInfo;
        }

        @Override
        public String getTitle() {
            return mTriggerInfo.mTriggerDisplayName;
        }

        @Override
        public String getSummary() {
            return mTriggerInfo.mCurrentState;
        }

        public String getTriggerId() {
            return mTriggerInfo.mTriggerId;
        }

        public String getTriggerPackage() {
            return mTriggerInfo.mPackage;
        }
        ...
        public List<String> getTriggerStates() {
            return mTriggerInfo.mStates;
        }
    }

    public static class ProfilePluginManager {
        public List<CustomTriggerInfo> getRegisteredTriggers() {
            return new ArrayList<>();
        }
    }

    public static class CustomTriggerInfo {
        String mPackage;
        String mTriggerId;
        String mTriggerDisplayName;
        List<String> mStates;
