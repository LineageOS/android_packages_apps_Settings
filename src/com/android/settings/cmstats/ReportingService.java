...
public class ReportingService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        int cyanogenJobId = AnonymousStats.getNextJobId(this);
        int cmOrgJobId = AnonymousStats.getNextJobId(this);
        ...
        // persist job id
        AnonymousStats.addJob(this, cyanogenJobId);
        AnonymousStats.addJob(this, cmOrgJobId);
