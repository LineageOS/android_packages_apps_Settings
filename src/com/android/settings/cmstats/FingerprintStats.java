...
//    public static void sendSettingsFingeprintEnrollmentFailedEvent(Context context,
//            String failureReason) {
//        sendFingerprintEnrollmentFailedEvent(context, Categories.FINGERPRINT_ENROLLMENT_SETTINGS,
//                failureReason);
//    }
//
//    public static void sendOobeFingeprintEnrollmentFailedEvent(Context context,
//            String failureReason) {
//        sendFingerprintEnrollmentFailedEvent(context, Categories.FINGERPRINT_ENROLLMENT_OOBE,
//                failureReason);
//    }
//
//    public static void sendSettingsFingerprintEnrollmentSuccessEvent(Context context) {
//        sendFingerprintEnrollmentSuccessEvent(context, Categories.FINGERPRINT_ENROLLMENT_SETTINGS);
//    }
//
//    public static void sendOobeFingerprintEnrollmentSuccessEvent(Context context) {
//        sendFingerprintEnrollmentSuccessEvent(context, Categories.FINGERPRINT_ENROLLMENT_OOBE);
//    }
