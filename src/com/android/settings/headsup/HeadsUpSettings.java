...
public class HeadsUpSettings extends SettingsPreferenceFragment
    ...
    private void recreate() {
        ...
        mAddDndPref.setSummary(getResources().getString(R.string.add_heads_up_dnd_summary));
        ...
        mAddBlacklistPref.setSummary(getResources()
                .getString(R.string.add_heads_up_blacklist_summary));
